...
public class JogoDaVelha extends JFrame{
    ...
    public JogoDaVelha(){
        ...
        novo.setBounds(410,120,140,30);
        zerar.setBounds(410,150,140,30);
    ...
    public void limpar() {
        for (int i = 0; i < 9; i++) {
            jogador.setText("Jogador X");/** Sempre iniciar exibindo que a vez é do Jogador 1.*/
            bt[i].setText("");
            click[i] = false;
            xo = false; /**  Sempre que Limpar o jogo, irá iniciar com x. */
